...
This document outlines the phased development plan for Attestar, from
...
| 1.2  | Fixed-point arithmetic library | `attestar-common::fixed_point` with tests   | In Progress |
...
**Objective:** Package Attestar as a reusable SDK and pursue ecosystem
...
- At least one external project integrates Attestar for provable
  inference.
