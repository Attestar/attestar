//! Command-line entrypoint for the attestar prover.
//!
//! Usage:
//!
//! ```text
...
//! ```
//!
//! Everything of substance lives in [`attestar_prover::cli`] so the command bodies
...
use attestar_prover::cli::{run, Cli, CliError};
use clap::Parser;
