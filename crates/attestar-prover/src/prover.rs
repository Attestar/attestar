...
use attestar_common::commitment::{commit_i64, commitment_hash, Commitment};
use attestar_common::fixed_point::FixedPoint;
use attestar_common::models::Model;
use attestar_common::proof::{Groth16Proof, PublicInputs, VerificationBundle};
...
pub use attestar_common::commitment::model_elements;
...
mod zkvm_prove {
    use super::*;
    use attestar_methods::{ATTESTAR_GUEST_ELF, ATTESTAR_GUEST_ID};
    ...
    pub fn generate_receipt(
        ...
        let prove_info = prover
            .prove(env, ATTESTAR_GUEST_ELF)
            .map_err(|e| format!("zkVM prove failed: {e}"))?;
        let receipt = prove_info.receipt;

        receipt
            .verify(ATTESTAR_GUEST_ID)
...
mod tests {
    use super::*;
    use attestar_common::models::LogisticRegression;
