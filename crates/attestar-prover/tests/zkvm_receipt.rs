...
//! is gated behind `#[ignore]` — see `crates/attestar-prover/README.md`.
//!
...
use attestar_prover::model_io::JsonModel;
use attestar_prover::prover::{generate_receipt, input_commitment, model_commitment};
...
fn case_to_model_inputs(case: &VectorCase) -> (attestar_common::models::Model, Vec<FixedPoint>) {
...
///
/// ```text
/// RISC0_DEV_MODE=0 cargo test -p attestar-prover --test zkvm_receipt real_proof -- --ignored --nocapture
/// ```
#[test]
