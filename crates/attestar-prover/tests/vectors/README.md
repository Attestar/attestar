...
This directory contains golden-vector test cases for the Attestar inference engine. These vectors serve as the canonical test suite for inference correctness and are reused across multiple testing contexts:
...
5. Run `cargo test -p attestar-prover` to verify
